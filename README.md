...
- **Fruit & veg market** - a colourful street market sets up in the central plaza on weekends and roughly 30% of weekdays. Eight stalls with striped awnings and produce displays appear in two rows; pedestrians wander over to browse between stalls
