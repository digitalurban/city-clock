...
- **Window lights** — building windows light up at night using time-quantised seeds (changing every 20 minutes) with three colour temperatures: warm incandescent, cool daylight, and blue TV glow. Each lit window has a soft radial halo that bleeds into the dark facade. Unlit windows show a dark recess
