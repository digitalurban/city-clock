...
- **Alarm System** - Set a custom time via the Options menu to trigger an alarm, causing the entire city population to dance in the plaza. A bandstand with a 5-piece band (singer, guitar, bass, drums, keys) appears in the upper plaza facing the audience, with floating musical notes. Snooze for 9 minutes or dismiss to stop the performance
